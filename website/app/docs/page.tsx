  ...
  return <main className="docsPage">
    ...
    <div className="docsLayout shell">
      ...
      <article className="docsContent">
        ...
        <h2 id="tools">Complete tool reference</h2><p>All 35 MCP tools are listed below. These descriptions closely mirror the metadata the LLM receives when it decides which tool to call.</p>
