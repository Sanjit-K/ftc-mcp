  ...
  return (
    <main>
      ...
      <section className="features shell" id="features">
        <div className="sectionHead"><div><p className="sectionKicker">30 TOOLS. FOUR JOBS.</p><h2>Everything between<br />the prompt and the robot.</h2></div><p>Purpose-built tools for the repetitive, fragile parts of an FTC codebase. Your AI handles the loop; your team reviews every diff.</p></div>
